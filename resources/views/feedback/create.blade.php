...
<i class="fa fa-envelope color-black"></i>Send Feedback
</h3>
</div>
</div>
<div class="row">
                ...
                <div class="form-body margin-top-30">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <!-- Message Form Input -->
                            <div class="form-group">
                                <label class="control-label">Feedback Text:</label>
                                <textarea name="comment" class="form-control" placeholder="Feedback Text" maxlength="250">{{Request::old('comment')}}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-actions right">
                            <a href="{{ URL::to('feedback') }}" class="btn btn-circle btn-danger bold red btn-sm">
                                Cancel </a>
