...
@media(max-width:480px) { .btn-danger{float: none !important; font-size:8px;}}
</style>
...
<i class="fa fa-money color-black"> </i> Your Received Leads
</h3>
...
<div class="col-md-12">
<div class="col-md-12">
            <div class="portlet-body form action_center" id="blockui_sample_1_portlet_body" style="float: left;width: 100%;padding: 10px!important;">
                @if (Session::has('message'))
                    <div id="" class="custom-alerts alert alert-success fade in"><button type="button" class="close" data-dismiss="alert" aria-hidden="true"></button>{{ Session::get('message') }}</div>
                @endif
                <div class="col-md-12 paddin-npt">
                <p class="caption-helper" style="margin-top: 0px!important;">Based on your Lead Requests, we’ve matched you with potential Buyers.</p>
                    <div class="col-md-6 col-sm-6 col-xs-6 margin-bottom-15">
                        ...
                        <select id="lead-select-filter" class="form-control" onchange="ApplyFilter();">
                            <option value="all">Filter Lead Requests</option>
                        ...
                        <div class="row">
                        <select id="received-quote-filter" onchange="ApplyFilter();" placeholder="Sort by:" class="form-control" style="width: 90%;float: left;">
                            ...
                            <option value="hidden_quotes" @if($sellerquote_hidden_name == 'hidden_quotes') selected="selected" @endif>View Hidden Leads</option>
                        </select>
                    ...
                    <div class="colmd12 @if($quote->status == 0) lead-inactive @elseif(strtotime(date('Y-m-d')) > strtotime($quote->expiry_date)) lead-expire @else lead-active @endif ">
                        <div class="row">
                          <div class="col-md-3 text-center"> 
                            ...
                            @endif
                            <h3>{{$quote->buyerUser->first_name}} {{$quote->buyerUser->last_name}}</h3> @if($quote->buyerCompany != '') <h5> {{$quote->buyerCompany->name}} @endif</h5>
                            ...
                            <ul class="list-inline profile_num no-margin">
                          ...
                          <div class="col-md-2 text-center">
                            ...
                            <div class="btn-group pull-right">
                              <div class="actions">
                                <div class="btn-group" >
                                    <a class="btn btn-circle yellow-crusta" href="javascript:;" data-toggle="dropdown" data-hover="dropdown" data-close-others="true"> Actions
...
-->
                                        <li>
                                            <a href="{{url('request-product-quotes')}}/{{$quote->id}}" id="quoteview_{{$quote->id}}">
                                           View Buy Request</a>
                                        </li> 
                                        ...
                                        <li>
                                            <a href="#message_modal" data-toggle="modal" data-target="#message_modal" onclick="messageUser({{$quote->created_by}})">
                                                Direct Message </a>
                                            <!--<a href="{{url('messages/create')}}?buyer={{$quote->created_by}}">Direct Message</a>-->
                                        </li>
                                        <li>
                                            <a target="_blank" href="{{url('lead/share')}}/{{$quote->created_by}}/{{$quote->id}}">Share this Lead</a>
                                        </li>
                                        <!--<li>
                                            <a href="{{url('feedback/create')}}?receiver_id={{$quote->created_by}}">Offer Feedback</a>
                                        </li> -->
<li>
                                            <a href="{{ URL::to('supplier/quote/ignore') }}/{{$userData->user_id}}/{{$quote->id}}">
                                            Ignore Lead </a>
                                        </li>
        ...
        <a href="{{url('supplier-leads/create')}}" class="pull-right btn btn-danger"><i class="fa fa-plus"></i> Get More Leads, Submit a Lead Request.</a>
      </div>
