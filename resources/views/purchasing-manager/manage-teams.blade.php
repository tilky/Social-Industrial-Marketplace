                    ...
                    <div class="page-actions">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li> <a href="{{url('/edit-purchasing-team')}}/{{$team['id']}}" target="_blank"> <i class="fa fa-eye"></i> Edit Team Details </a> </li>
                                <li class="divider"> </li>
                                <li> <a href="{{url('/manage-purchasing-team-members')}}?team_id={{$team['id']}}" target="_blank"> <i class="fa fa-envelope"></i> Manage Members </a> </li>
                                <li class="divider"> </li>
                                <li> <a href="{{url('/edit-purchasing-team')}}/{{$team['id']}}#tab2" target="_blank"> <i class="fa fa-envelope"></i> Invite New Members </a> </li>
                                <li class="divider"> </li>
                                <li> <a href="{{url('/message-purchasing-team')}}?team_id={{$team['id']}}"> <i class="fa fa-envelope"></i> Message Team </a> </li>
                                <li class="divider"> </li>
                                <li>
                                    <a id="deleteButton" data-id="{{$team['id']}}" data-toggle="modal" href="#deleteConfirmation">
                                        ...
                                        'route'=>['purchasingManager.destroy',$team['id']]]) !!}
                                        {!! Form::close() !!}
...
<script>
    ...
    $('#manage-purchasing-teams').addClass('active');
