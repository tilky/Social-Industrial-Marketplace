              ...
              <tr>
                  ...
                  <td><div class="btn-group"> <a class="btn btn-circle yellow-crusta" href="javascript:;" data-toggle="dropdown" data-hover="dropdown" data-close-others="true"> Actions <i class="fa fa-angle-down"></i> </a>
                          <ul class="dropdown-menu pull-right">
                              ...
                              <li class="divider"> </li>
                              <li> <a href="{{url('cancel-buy-request-assignment')}}/{{$buyRequest['assigned_id']}}" ><i class="fa fa-pencil-remove"></i> Cancel Assignment</a> </li>
                          </ul>
                      </div>
                  </td>
              </tr>
...
<script>
    ...
    $('#view-assigned-buy-requests').addClass('active');

    function ApplyFilter()
    {
        var team_id = $('#received-team-filter').val();

        var redirect_url = '{{url("view-assigned-buy-requests")}}?team_id='+team_id;
