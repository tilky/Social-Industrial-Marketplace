...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li> <a href="{{url('referrals')}}">About Purchasing Teams</a> <i class="fa fa-circle"></i> </li>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="portlet-body form">
                ...
                <!-- BEGIN FORM-->
                {!! Form::open(['url'=>'transferManagerForBuyer','class'=>'horizontal-form form-horizontal','method'=>'POST']) !!}
                <div class="col-md-12">
...
<script>
    ...
    $('#transfer-purchasing-team').addClass('active');
