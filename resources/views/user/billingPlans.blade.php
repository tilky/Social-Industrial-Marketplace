            ...
            <div class="form-wizard">
                <div class="form-body">
                    ...
                    <div id="bar" class="progress progress-striped" role="progressbar">
                        <div class="progress-bar progress-bar-success" style="width: 66.66%!important;"> </div>
                    </div>
                    <h3>Selecte your Billing Plan</h3>
                    <form method="post" action="{{url('user/billing/save')}}" role="form" id="payment-form"  class="form-horizontal form-row-seperated">
                        ...
                        <div class="form-group">
                            ...
                            @foreach($billingPlans as $plan)
                                <label>
                                    <input type="radio" name="billing_plan" value="{{$plan->id}}" > {{$plan->name}} - {{$plan->amount}}
                                </label>
                            @endforeach
                            </div>
                        </div>
                        ...
                        <div class="form-actions right padding-top align-right">
                            <a href="{{url('user/company/select')}}" class="btn btn-circle default button-previous">
                                <i class="fa fa-angle-left"></i> Back </a>
                            
                            <button type="submit" class="subscribe btn btn-circle yellow-crusta color-black"> Submit
                                <i class="fa fa-angle-right"></i>
                            </button>
                            <a href="{{url('user/invitation')}}" class="btn btn-danger button-next">Continue
...
function payWithStripe(e) {
    ...
    var PublishableKey = '{{$strip_public_key}}'; // Replace with your API publishable key
    ...
    Stripe.card.createToken(ccData, function stripeResponseHandler(status, response) {
        if (response.error) {
            /* Visual feedback */
            $form.find('.subscribe').html('Something went wrong. Please check your details and try again.').prop('disabled', false);
