        ...
        <div  class="portlet-body form">
            ...
            <div class="form-wizard">
                <div class="form-body">
                    ...
                    <form method="post" action="{{url('user/packages/save')}}" role="form" id="payment-form"  class="form-horizontal form-row-seperated">
                        ...
                        <div class="form-group">
                            ...
                            @foreach($billingPlans as $plan)
                                <label>
                                    ...
                                    <input type="radio" name="billing_plan" value="{{$plan->id}}" @if($_REQUEST['value'] == $plan->id) checked @endif > {{$plan->name}} - ${{$plan->amount}}
                                    @else
                        ...
                        <div class="form-actions right padding-top align-right">
                            <a href="{{url('user/packages')}}" class="btn btn-circle default button-previous">
...
function payWithStripe(e) {
    ...
    Stripe.card.createToken(ccData, function stripeResponseHandler(status, response) {
        if (response.error) {
            ...
            /* Visual feedback */
            $form.find('.subscribe').html('Please wait while we process your payment. <i class="fa fa-spinner fa-pulse"></i>');
