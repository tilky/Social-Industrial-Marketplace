                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade active in" id="tab_1_1">
                            ...
                            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                ...
                                <tbody>
                                <tr>
                                    <td>{{$activeBuyerPackage->name}}</td>
                                    <td>{{$activeBuyerPackage->subscription_start}}</td>
                                    <td>{{$activeBuyerPackage->subscription_end}}</td>
                                    <td>{{$activeBuyerPackage->status}}</td>
                                    <td>
                                        <a href="{{url('user/payment-invoice')}}/{{$activeBuyerPackage->payment_id}}" class="btn btn-circle btn-success btn-sm">
                                            View/Print Invoice</a>
                                        @if($activeBuyerPackage->is_canceled == 0)
                                        <a href="{{url('user/packages/unsubscribe')}}/{{$activeBuyerPackage->id}}" class="btn btn-circle btn-success btn-sm">
                                            Cancel </a>
                                        @endif
                                    </td>
                                </tr>
