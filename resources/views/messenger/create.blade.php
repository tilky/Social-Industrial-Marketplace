...
<i class="fa fa-envelope color-black"></i> Send Message
</h3>
</div>
</div>
<div class="row">
    ...
    <div class="col-md-12">
            <div class="portlet-body form">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        @if($buyerData != '')
                                            @if($buyerData->access_level == 4)
                                            <option value="{{$buyerData->id}}" selected="">{{$buyerData->companydetail->name}}</option>
                                            @else
                                            <option value="{{$buyerData->id}}" selected="">{{$buyerData->userdetail->first_name}} {{$buyerData->userdetail->last_name}}</option>
                                            @endif
                                        @endif
                                        </select>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="subject" value="@if($titleData != '') {{$titleData}} @else {{Request::old('subject')}} @endif" class="form-control" placeholder="Message Subject" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="inbox-editor inbox-wysihtml5 form-control" name="message" rows="12">{{Request::old('message')}}</textarea>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="form-actions right">
                    <a href="{{ URL::to('marketplaceproducts') }}" class="btn btn-danger btn-sm bold">
                        Cancel </a>
