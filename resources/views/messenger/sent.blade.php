...
<h3 class="page-title uppercase"> Manage Inbox </h3>
</div>
</div>
<div class="row">
            ...
            <!-- BEGIN PAGE BASE CONTENT -->
                                        ...
                                        <table class="table table-striped table-bordered table-hover dt-responsive table-advance" width="100%" id="search-result-table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="media alert {!!$class!!}">
                                                    ...
                                                    <td>@if($class != '') <i class="fa fa-envelope-square"></i>@else <i class="fa fa-envelope-o"></i>@endif {{ $thread->subject}}</td>
                ...
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    ...
                    <li class="divider"> </li>
                    <li> <a id="deleteButton" data-id="{{$thread->id}}" data-toggle="modal" href="#deleteConfirmation">
