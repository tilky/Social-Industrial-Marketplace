            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-actions align-right">
                        <a href="{{url('supplier-quote/edit')}}/{{$quotes->id}}" class="btn btn-circle red bold btn-circle ">
                            <i class="fa fa-edit"></i> Edit Quote</a>
                        <a href="{{url('supplier-quote/submit')}}/{{$quotes->id}}" class="btn btn-circle yellow-crusta bold color-black  btn-circle ">
                            <i class="fa fa-check"></i> Submit QUote</a>
                    </div>
                </div>
            </div>
            </div>
