          ...
          <div class="portlet light request_page">
            ...
            <div class="col-md-12 col-sm-12 invoice_id">
                  ...
                  @if($quotes->sellerCompany != '')
                      <a href="{{url('company/profile')}}/{{$quotes->sellerCompany->id}}" target="_blank">
                      @if($quotes->sellerCompany->logo != '')
                      <img class="img-responsive" src="{{url('')}}/{{$quotes->sellerCompany->logo}}" width="80">
                      @else
                      <img class="img-responsive" src="//www.gravatar.com/avatar/18051c749493cc76ad88dd94789cc74e?s=64" width="80">
                      @endif
                      </a>
                  @else
                    <img class="img-responsive" src="//www.gravatar.com/avatar/18051c749493cc76ad88dd94789cc74e?s=64" width="80">
                  ...
                  <span class="label label-sm label-default"> 
                    @if($quotes->companyUser->quotetek_verify == 1)
                          ...
                          <div class="col-md-5 col-sm-5 text-center user_info">
                            ...
                            <h3 class="font-red bold uppercase pull-left">Quote From:</h3>
                              ...
                              <div class="mt-comment-img"> 
                                ...
                                @else
                                <img class="img-circle" src="//www.gravatar.com/avatar/18051c749493cc76ad88dd94789cc74e?s=64" height="80px" width="80px">
                                @endif
                              </div>
                          ...
                          <div class="mt-comment-body">
                            ...
                            <div class="col-md-12 col-sm-12 border_top border_bottom sender_notes">
                              ...
                              <div class="mt-comment-body">
                               ...
                               <h3 class="font-red bold uppercase no-margin">Notes From Sender:</h3>
            ...
            <table class="table table-striped table-bordered table-hover dt-responsive invoice_table" width="100%" id="sample_1">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <h5><span class="font-red">ITEM ID:</span> {{$item->item_number}}</h5>
                        <div class="h5 pull-left">{{$item->title}}</div>
                        <div class="clearfix"></div>
