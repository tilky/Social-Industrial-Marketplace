...
<i class="fa fa-user color-black"></i>Create a New Quote
</h3>
</div>
</div>
...
<h4 class="font-red-mint"><strong>Quote Details:</h4> 
                        ...
                        <div class="form-group">
                            <div class="col-md-6 paddin-npt padding-right">
                                ...
                                <div class="col-md-12 paddin-npt">
                                    <input type="text" name="company_quote_number" value="{{Request::old('company_quote_number')}}" class="form-control" required placeholder="Enter Your Company Quote Number" />
                                </div>
                            </div>
                            <div class="col-md-6 paddin-npt">
                                <label class="col-md-12 paddin-npt">Your Company Tax ID (optional):</label>
                                <div class="col-md-12 paddin-npt">
                                    <input type="text" name="company_tax_number" value="{{Request::old('company_tax_number')}}" class="form-control" required placeholder="Enter your company Tax ID (Optional)" />
                                </div>
                            </div>
                        </div>
                       ...
                       <div class="form-group">
                            ...
                            <button type="button" id="{{url('company/reference/add/1')}}" class="btn btn-circle yellow-crusta color-black reference-add-btn-1" onclick="showAddModal(id,'first')"  ><i class="fa fa-plus"></i> Add an Item </button>
                        </div>
                                ...
                                <div class="col-md-12 paddin-npt">
                                    <div class="">
                                        <div class="input-group input-large date date-picker" data-date-format="yyyy-mm-dd" data-date-start-date="+0d">
                                            <input type="text" class="form-control" required name="expiry_date" value="{{Request::old('expiry_date')}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 paddin-npt" id="sales-amount-div" style="display: none;">
                                ...
                                <div class="col-md-12 paddin-npt">
                                    <input type="number" id="salestax-amount" name="salestax_amount" value="{{Request::old('salestax_amount')}}" class="form-control" required placeholder="Enter the tax percentage. For example, 9.5." />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12 paddin-npt">
                                <textarea class="form-control" name="custom_note" placeholder="Add additional details to your Quote.">{{Request::old('custom_note')}}</textarea>
                            </div>
                        </div>
                       <div class="form-group">
                            <label class="col-md-12 paddin-npt">Acceptable Payment Terms:</label>
                            <div class="col-md-12 paddin-npt">
                                <textarea class="form-control" name="payment_terms" placeholder="Add acceptable Payment Terms">{{Request::old('payment_terms')}}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-actions right">
                        <a href="{{ URL::to('supplier-sent-quote') }}" class="btn bold btn-danger">
                           <i class="fa fa-remove"></i>  Cancel Quote</a>
