...
<head>
    <meta charset="utf-8" />
    <title>QuoteTek Super Admin</title>
    ...
    <link href="{{URL::asset('metronic/pages/css/login.min.css')}}" rel="stylesheet" type="text/css" />
...
<div class="logo">
    <a href="index.html">
        <img src="{{URL::asset('livesite/images/logo.png')}}" alt="" /> </a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
    <div class="row">
        <div class="col-md-12 page-500">
            <div class=" details">
                ...
                <p style="text-align: center"><a href="{{url()}}" class="btn btn-danger btn-outline"> Click here to Return back to the Homepage </a></p>
            </div>
        </div>
    </div>
</div>
<div class="copyright"> © Indy John Inc. All Rights Reserved. </div>
<!--[if lt IE 9]>
<script src="{{URL::asset('metronic/plugins/respond.min.js')}}"></script>
<script src="{{URL::asset('metronic/plugins/excanvas.min.js')}}"></script>
<![endif]-->
<!-- BEGIN CORE PLUGINS -->
...
<script src="{{URL::asset('metronic/pages/scripts/login.min.js')}}" type="text/javascript"></script>
