...
.requestquote{width: 33%!important;right: 8%!important;margin: 30px 0px 0px!important;}
...
<div class="requestquote register clearfix animatedParent">
    <div class="row animated fadeIn slower">
        <form class="form-horizontal" role="form" method="POST" action="{{url()}}/auth/register">
            ...
            <input type="hidden" name="referral_code" value="{{$_GET['referral']}}" />
            @endif
            ...
            <div class="col-md-12 paddin_rt5"><input type="email" name="email" placeholder="E-Mail" value="{{ old('email') }}"/></div>
            <div class="col-md-6 paddin_rt5"><input type="password" name="password" placeholder="Password"/></div>
            <div class="col-md-6 paddin_lt5"><input type="password" placeholder="Confirm Password" name="password_confirmation"/></div>
            <div class="col-md-12" style="margin-bottom: 10px;">
                <div class="auto-widget">
                    <label style="width: 20%;">Compnay </label>
                <select id="select2-button-addons-single-input-group-sm" name="company" class="js-data-products-ajax" style="80%"></select> 
                </div>
            </div>
