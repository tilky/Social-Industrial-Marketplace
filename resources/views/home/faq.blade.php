...
@section('content')
@include('home.header')
<link href="{{URL::asset('metronic/assets/pages/css/faq.min.css')}}" rel="stylesheet" type="text/css" />
<div class="faq-page"> 
  <!--======================= layout ========================-->
  
  <div class="small-layout" style="background-image: url('{{URL::asset('livesite/images/banners/8.jpg')}}') ;">
    <div class="mask"></div>
