    ...
    <div class="col-md-12">
        <div class="portlet box red">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-gift"></i>Add Paypal</div>
            </div>
            ...
            <div class="portlet-body form">
                ...
                @endif
                <!-- BEGIN FORM-->
                <form action="{{url('referral/payment/paypal/save')}}" method="POST" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            <div class="col-md-6">
                                ...
                                <input data-required="1" type="text" name="paypal_email" class="form-control" placeholder="Paypal Email">
