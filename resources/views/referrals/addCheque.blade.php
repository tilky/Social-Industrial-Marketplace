    ...
    <div class="col-md-12">
        <div class="portlet box red">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-gift"></i>Add Cheque Details</div>
            </div>
            ...
            <div class="portlet-body form">
                ...
                @endif
                <!-- BEGIN FORM-->
                <form action="{{url('referral/payment/cheque/save')}}" method="POST" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            <div class="col-md-6">
                                ...
                                <input data-required="1" type="text" name="payee_name" value="{{Request::old('payee_name')}}" class="form-control" placeholder="Payee Full Name">
                            </div>
                            <div class="col-md-6">
                                <label class="control-label">Company Name</label>
                                <input type="text" name="company_name" value="{{Request::old('company_name')}}" class="form-control" placeholder="Company Name">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-6">
                                <label class="control-label">Address Line 1<span class="required" aria-required="true"> * </span></label>
                                <input data-required="1" type="text" name="address1" value="{{Request::old('address1')}}" class="form-control" placeholder="Address Line 1">
                            </div>
                            <div class="col-md-6">
                                <label class="control-label">Address Line 2</label>
                                <input type="text" name="address2" class="form-control" value="{{Request::old('address2')}}" placeholder="Address Line 2">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="state" class="form-control" value="{{Request::old('state')}}" placeholder="State/Region">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="zip" class="form-control" value="{{Request::old('zip')}}" placeholder="Postal Code">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-6">
                        ...
                        <div id="taxt-info" style="display: none;">
                            <h3>Tax Information Requirement:</h3>
                            <div id="for-us-only" style="display: none;">
                            <P>*The following fields are required because Referral payouts exceeding certain limits are taxable. Contact your tax professional to learn more.  </P>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-9">
                                            <input data-required="1" type="text" name="legal_name" value="{{Request::old('legal_name')}}" class="form-control" placeholder="Legal Name">
                                        </div>
                                    </div>
                                </div>
                                <p>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                    <input type="radio" name="account_type" value="1" checked="" />I am registering this account as an individual, sole proprietor with no EIN, or other business entity with no EIN.
                                    </div>
                                    ...
                                    <div id="account_type2" class="col-md-6 desc" style="display: none;">
                                        ...
                                        <input data-required="1" type="text" name="federal_employer_identification_number" id="mask_tin" value="{{Request::old('federal_employer_identification_number')}}" class="form-control" placeholder="Federal Employer Identification Number (EIN)">
                                        <p>For Example: 12-3456789</p>
                                    </div>
                                    
                                </div>
                                <p>You will be paid according to the User Agreement.</p>
                            </div>
                            <div id="for-all-other" style="display: none;">
                                ...
                                <p> Your privacy is very important to us - this tax information will be encrypted and stored securely. Please contact Customer Support if you have any questions.</p>
                            </div>
                        </div>
                    </div>
