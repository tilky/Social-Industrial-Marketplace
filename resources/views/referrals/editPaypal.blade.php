    ...
    <div class="col-md-12">
        <div class="portlet box red">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-gift"></i>Edit Paypal</div>
            </div>
            ...
            <div class="portlet-body form">
                ...
                @endif
                <!-- BEGIN FORM-->
                <form action="{{url('referral/payment/paypal/update')}}" method="POST" class="form-horizontal">
                    <input type="hidden" name="_token" value="{{csrf_token()}}" />
                    <input type="hidden" name="paypal_id" value="{{$paypal->id}}" />
                    <input type="hidden" name="user_id" value="{{$paypal->user_id}}" />
                    <input type="hidden" name="payment_via" value="Paypal" />
                    <div class="form-body">
                        <div class="form-group">
                            <div class="col-md-6">
                                <label class="control-label">Paypal Email <span class="required" aria-required="true"> * </span></label>
                                <input data-required="1" type="text" name="paypal_email" value="{{$paypal->paypal_email}}" class="form-control" placeholder="Paypal Email">
                                <span>(you provide email must match your PayPal account)</span>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-6">
                                <label class="control-label">Payee Full Name<span class="required" aria-required="true"> * </span></label>
                                <input data-required="1" type="text" name="payee_name" value="{{$paypal->payee_name}}" class="form-control" placeholder="Payee Full Name">
                            </div>
                            <div class="col-md-6">
                                <label class="control-label">Company Name</label>
                                <input type="text" name="company_name" value="{{$paypal->company_name}}" class="form-control" placeholder="Company Name">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-6">
                                <label class="control-label">Address Line 1<span class="required" aria-required="true"> * </span></label>
                                <input data-required="1" type="text" name="address1" value="{{$paypal->address1}}" class="form-control" placeholder="Address Line 1">
                            </div>
                            <div class="col-md-6">
                                <label class="control-label">Address Line 2</label>
                                <input type="text" name="address2" class="form-control" value="{{$paypal->address2}}" placeholder="Address Line 2">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-6">
                                ...
                                <select name="country" class="form-control select2" id="country-dropdown">
                                    @foreach($countries as $country)
                                        @if($paypal->country == $country->country_name)
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="state" class="form-control" value="{{$paypal->state}}" placeholder="State/Region">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-6">
                                <label class="control-label">City<span class="required" aria-required="true"> * </span></label>
                                <input data-required="1" type="text" name="city" value="{{$paypal->city}}" class="form-control" placeholder="City">
                            </div>
                            <div class="col-md-6">
                                <label class="control-label">Postal Code<span class="required" aria-required="true"> * </span></label>
                                <input type="text" name="zip" class="form-control" value="{{$paypal->zip}}" placeholder="Postal Code">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-6">
                                <label class="control-label">Phone Number<span class="required" aria-required="true"> * </span></label>
                                <input data-required="1" type="text" name="phone" value="{{$paypal->phone}}" class="form-control" placeholder="Phone Number">
                            </div>
                        </div> 
                            ...
                            <div id="for-us-only" style="display: none;">
                                ...
                                <div class="form-group">
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-9">
                                            <input data-required="1" type="text" name="legal_name" value="{{$paypal->legal_name}}" class="form-control" placeholder="Legal Name">
                                        </div>
                                    </div>
                                </div>
                                <p>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                    <input type="radio" name="account_type" value="1" @if($paypal->account_type == 1) checked="" @endif />I am registering this account as an individual, sole proprietor with no EIN, or other business entity with no EIN.
                                    </div>
                                    ...
                                    <div id="account_type2" class="col-md-6 desc" style="display: none;">
                                        ...
                                        <input data-required="1" type="text" name="federal_employer_identification_number" id="mask_tin" value="{{$paypal->federal_employer_identification_number}}" class="form-control" placeholder="Federal Employer Identification Number (EIN)">
...
$(document).ready(function(){
    var country = '{{$paypal->country}}';
    var account_type = '{{$paypal->account_type}}';
