...
<i class="fa fa-plus"></i> Upload Your Catalog
</h3>
...
<div class="row">
    ...
    <div class="col-md-12">
            <div class="portlet-body form" id="blockui_sample_1_portlet_body" style="float: left;width: 100%;">
                ...
                <div class="row">
                <p class="caption-helper">Upload your Company Catalog to Indy John. We will auto-select your Product-Categories and create a Lead Request for your offering.</p>
                </div>
                </div>
                <!-- BEGIN FORM-->
                {!! Form::open([
                ...
                'files' => true,
                'id' => 'upload-catalog-form'
                ]) !!}
                    <input type="hidden" name="created_by" value="{{$userData->user_id}}" />
                    <input type="hidden" name="status" value="1" />
                    <input type="hidden" name="catalog_upload" value="1" />
                    <div class="form-body padding-15" style="float: left;width: 100%;">
                        <h3 class="block align-left paddin-npt no-margin paddin-npt"><span style="font-size: 19px!important;">What best describes your Product-Category Offering? Select all that apply.</span></h3>
                        ...
                        <div class="form-group">
                            <!--<h3 class="block align-left"><span style="font-size: 19px!important;">Browse and Upload your Catalog File</span></h3>-->
                            <label for="inputEmail3" class="col-md-12 paddin-npt">Browse and Upload your Catalog File:</label>
                            <div class="col-md-12 paddin-npt">
                                <input type="hidden" name="file_path" value="" id="hidden_file_name" />
                                <div class="fileinput fileinput-new" data-provides="fileinput" style="margin-bottom:0px !important;">
                                    <div class="input-group input-large">
                                        <div class="form-control uneditable-input input-fixed input-medium" data-trigger="fileinput">
                                            <i class="fa fa-file fileinput-exists"></i>&nbsp;
                                            <span class="fileinput-filename"> Click here to upload a WORD/PDF/Excel/CSV/TXT file</span>
                                        </div>
                                        <span class="input-group-addon btn btn-circle btin-danger default red btn-file" style="display:table-cell !important;">
                                            <span class="fileinput-new red"> Select file </span>
                                            <span class="fileinput-exists"> Change </span>
                                            <input type="file" data-required="1" name="upload_catalog" id="upload_catalog"> </span>
                                            
                                        <a href="javascript:;" class="input-group-addon btn btn-circle default fileinput-exists" data-dismiss="fileinput"> Remove </a>
                                    </div>
                                </div>
                                <span class="help-block" style="margin-top:0px !important;">Additional catalogs can be uploaded by repeating this process.</span>
                            </div>
                        </div>
                        <div class="form-group">
                            <!--<h3 class="block align-left"><span style="font-size: 19px!important;">Select Applicable Industrial Markets</span></h3>-->
                            <label for="inputEmail3" class="col-md-12 paddin-npt">Enter all Industrial Markets you serve:</label>
                            <div class="col-md-12 paddin-npt">
                        ...
                        <div class="col-md-12 paddin-npt padding-top">
                            <p class="bold">Note: This is usually a quick process but depending on the size, upload may take up to 24 hours. </p>
                            <p class="bold">Once completed, your catalog items will show as a Lead Request in your <a href="{{url('supplier-leads')}}">"Lead Request Manager"</a></p>
                        </div>
                        
                    </div>
                    <div class="form-actions right" style="float: left;width: 100%;">
                        <a href="{{ URL::to('supplier-lead/upload-catalog/history') }}" class="btn btn-danger bold">
                            Submission History </a>
                        <button type="button" id="submit-catalog" class="btn btn-circle yellow-crusta color-black bold">
...
$('#catalog-upload-menu').addClass('active');
/* end menu active */
...
$(document).ready(function() {
    ...
    var placeholder = "Type and Select Industries";
...
var categoryPlaceholder = 'Type and select one or more Product-Categories that you offer.';
...
var industryPlaceholder = 'Type and Select Industries'; 
