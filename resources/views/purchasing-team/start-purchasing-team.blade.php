...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            @if(isset($buyerTeam->id))
            <span>Edit Purchasing Team</span>
            @else
...
<div class="row">
    <div class="col-md-12 border2x_bottom" id="form_wizard_1">
      <h3 class="page-title uppercase">
        <i class="fa fa-group color-black"> </i> @if(isset($buyerTeam->id)) Edit Purchasing Team @else Start a New Purchasing Team @endif
      </h3>
    </div>
</div>
    ...
    <div class="col-md-12 col-sm-12">
        <div class="col-md-12 col-sm-12">
            ...
            @endif
                ...
                <!-- BEGIN FORM-->
                {!! Form::open(['url'=>'savePurchasingTeam','class'=>'horizontal-form form-horizontal submitTeam','method'=>'POST','files' => true,'id' => 'req-form-quote']) !!}
                <input type="hidden" id="inviteNowOrLater" name="invite" value="">
                <input type="hidden" name="id" value="{{$buyerTeam->id}}" />
                        ...
                        <div class="tab-content">
                            ...
                            @endif
                                <div class="col-md-12 font-red-mint padding-top" id="first-step-quote">
                                    <h3 class="block  align-left"><span style="font-size: 20px!important;">Start a Purchasing Team </span></h3>
                                </div>
                                ...
                                <div class="form-group paddin-bottom">
                                    <ul class="start_team"><li><i class="fa fa-check color-black"> </i> Create Buy Requests and Assign them to team members</li>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12 paddin-npt">
                                        ...
                                        <input class="form-control" type="text" name="name" value="{{$buyerTeam->name}}" placeholder="Enter Team Name here Your Team" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12 paddin-npt">
                                        <select class="form-control" name="type" placeholder="Select Team Type">
                                            <option value="Private" {{($buyerTeam->type == "Private" ? 'selected="selected"' : '')}}>Private Team</option>
                                            <option value="Public" {{($buyerTeam->type == "Public" ? 'selected="selected"' : '')}}>Public Team</option>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12 paddin-npt">
                                        <textarea rows="2" class="form-control"  maxlength="300" type="textarea" name="description" value="{{$buyerTeam->description}}" placeholder="Add a Team Summary."></textarea>
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="col-md-12 paddin-npt">
                                        <select class="form-control" name="label" placeholder="Select Sorting Label">
                                            <option value="Region" {{($buyerTeam->label == "Region" ? 'selected="selected"' : '')}}>Territories</option>
                                           
                                            <option value="Categories" {{($buyerTeam->label == "Categories" ? 'selected="selected"' : '')}}>Product-Categories</option>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    @if(isset($buyerTeam->id))
                                    <input type="text" name="tags" value="{{$buyerTeamTags}}" data-role="tagsinput" id="taginputin" placeholder="Type something and hit enter" />
                                    @else
                            ...
                            @endif
                                <div class="form-group">
                                    ...
                                    <label class="col-md-12 paddin-npt"><b>Invite Users By E-mail:</b></label>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12 paddin-npt">
                                            <label><b>Invite Connected Indy John Users:</b></label>
                                            @if(isset($buyerTeam->id))
                                            <select id="select2-button-addons-single-input-group-sm" name="indyJohnUsers[]" class="form-control col-md-12 js-data-connection-ajax" multiple >
                                                @foreach($buyerArray as $mapping)
                                                <option value="{{$mapping['userId']}}" selected>{{$mapping['userName']}}</option>
                                                @endforeach
                                            </select>
                                            @else
                                            <select id="select2-button-addons-single-input-group-sm" name="indyJohnUsers[]" class="form-control col-md-12 js-data-connection-ajax"  multiple>
...
{{--
                                    <div class="col-md-12 margin-bottom-15">
                                        <label class="col-md-12 paddin-npt">Invite Connected Indy John Users:</label>
                                        <p>
...
<script>
    ...
    $('#start-purchasing-team').addClass('active');
