            ...
            <div class="portlet light ">
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" >
                        ...
                        <tbody>
                        @if(count($supplierTeamArray) > 0)
                            @foreach($supplierTeamArray as $member)
                            <tr>
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                ...
                                                <li>
                                                    <a id="deleteButton" data-id="{{$member['userId']}}" data-toggle="modal" href="#deleteConfirmation">
                                                        ...
                                                        'route'=>['supplierTeam.destroy',$member['userId']]]) !!}
                                                        {!! Form::close() !!}
...
<script>
    ...
    $('#manage-supplying-team-members').addClass('active');
    ...
    function ApplyFilter()
    {
        ...
        var redirect_url = '{{url("manage-supplying-team-members")}}?team_id='+team_id;
    ...
    jQuery(document).ready(function () {
        ...
        if(team_id)
        {
            var redirectUrl = '{{url("edit-supplying-team/")}}/'+team_id+'#tab2';
