...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li> <span>Supplying Teams</span> </li>
    </ul>
</div>
        ...
        <div class="col-md-12">
            <div class="col-md-12">
                ...
                <div class="col-md-9 paddin-npt">
                    <p class="caption-helper">Supplying Teams that you're a part of: </p>
                </div>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-right">
                                            <li> <a href="{{url('viewTeamMembers/')}}/{{$team['teamId']}}" target="_blank"><i class="fa fa-eye"></i> View Members</a></li>
                                            <li><a href="{{url('/message-supplying-team')}}?team_id={{$team['teamId']}}" target="_blank"><i class="fa fa-inbox"></i> Group Messages</a></li>
                                            <li>
                                                <a href="{{url('/view-assigned-lead-requests')}}?team_id={{$team['teamId']}}" target="_blank"><i class="fa fa-file-text-o"></i> View Assigned Lead Requests </a>
                                            </li>
                                        </ul>
                                    </div>
                                </td>
