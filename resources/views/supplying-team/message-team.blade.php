                ...
                <div class="col-md-12">
                    <div class="portlet-body form">
                        ...
                        <div class="form-actions right">
                            <a href="{{ URL::to('manage-my-supplying-teams') }}" class="btn btn-danger btn-sm bold">
                                Cancel </a>
...
<script>
    ...
    $('#message-supplying-team').addClass('active');
...
<script>
    ...
    function ApplyFilter()
    {
        ...
        var redirect_url = '{{url("message-supplying-team")}}?team_id='+team_id;
