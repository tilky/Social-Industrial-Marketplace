                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="portlet_comments_1"> 
                                ...
                                <div class="mt-comments col-md-12 col-sm-12 center-block no_filter">
                                    ...
                                    <div class="mt-comment result">
                                        ...
                                        <div class="mt-comment-body">
                                                ...
                                                <div class="actions pull-right">
                                                    <div class="btn-group"> 
                                                        ...
                                                        <ul class="dropdown-menu pull-right">
                                                            ...
                                                            <li class="divider"> </li>
                                                            <li>
                                                            <a id="deleteButton" data-id="{{$conatct->id}}" data-toggle="modal" href="#deleteConfirmation" class="">
                                        
                                                            {!! Form::open([
                                                            'method' => 'DELETE',
                                                            'id' => 'DELETE_FORM_'.$conatct->id,
                                                            'route' => ['contactusers.destroy', $conatct->id]
                                                            ]) !!}
                                                            {!! Form::close() !!}
                                            ...
                                            @if($conatct->user->access_level == 4)
                                                <div class="mt-comment-text">{{substr($conatct->user->companydetail->description,0,90)}}</div>
                                                <span class="mt-comment-status">@if($conatct->user->companydetail->city != ''){{$conatct->user->companydetail->city}},{{$conatct->user->companydetail->state}},{{$conatct->user->companydetail->country}} @endif </span>
                                            @else
                        ...
                        @else
                            ...
                            <div class="row">
                                <p class="text-center res_found">You have not requested any User Connections. Start by clicking on Invite Users.</p>
                                </div>
                            </div>
                        @endif
                    </div>
