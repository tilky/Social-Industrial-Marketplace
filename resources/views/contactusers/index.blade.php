...
/*.center-nav>li>a{padding: 12px 55px 13px !important;}*/
</style>
<div class="page-bar">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="portlet_comments_1"> 
                                                ...
                                                <div class="actions pull-right">
                                                    <div class="btn-group"> 
                                                        ...
                                                        <ul class="dropdown-menu pull-right">
                                                            ...
                                                            <li class="divider"> </li>
                                                            <li>
                                                                <a href="{{url('messages/create')}}?buyer={{$conatct->user->id}}" target="_blank">
                        ...
                        @else
                            ...
                            <div class="row">
                                <p class="text-center res_found">You do not have any User Connections. Start by clicking on Invite Users.</p>
                                </div>
                            </div>
                        @endif
                    </div>
