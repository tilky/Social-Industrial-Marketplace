...
Hello, {{Auth::user()->userdetail->first_name}}.
    @endif
</h3>
...
<div class="row">
    ...
    <div class="col-md-12 col-sm-12"><h4 class="bold">NEW NOTIFICATIONS</h4></div>
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <a class="dashboard-stat dashboard-stat-v2 yellow" href="{{url('supplier-quotes')}}">
                 <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="{{count($quote_received)}}"></span>
                    </div>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <a class="dashboard-stat dashboard-stat-v2 yellow" href="{{url('messages')}}">
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="{{count($threads_cnt)}}">0</span></div>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <a class="dashboard-stat dashboard-stat-v2 yellow" href="{{url('contact/user/pending')}}">
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="{{$contact_cnt}}">0</span></div>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <a class="dashboard-stat dashboard-stat-v2 yellow" href="{{url('endorsement')}}">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="{{$endorsements_cnt}}">0</span></div>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <a class="dashboard-stat dashboard-stat-v2 yellow" href="{{url('request-product-quotes/create')}}">
                <div class="details text-center">
                   <img src="{{URL::asset('images/icons/fast.svg')}}" height="60px" width="60px"/>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <a class="dashboard-stat dashboard-stat-v2 yellow" href="{{url('market/post-your-product')}}">
                ...
                <div class="details text-center">
                <i class="fa fa-3x fa-tags center-block"></i>
 ...
 <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <a class="dashboard-stat dashboard-stat-v2 yellow" href="{{url('quotetek/user/verification')}}">
                ...
                <i class="fa fa-3x fa-check-circle center-block"></i>
                @else
              ...
              <div class="tab-content portlet-body" id="blockui_sample_2_portlet_body">
                <div class="tab-pane active" id="tab1">
                  <div class="portlet-body" id="blockui_sample_2_portlet_body">
                    ...
                    <ul class="feeds">
                            ...
                            <li>
                                <div class="col1">
                                    <div class="cont" style="margin: 0px!important;">
                                        ...
                                        <div class="cont-col2">
                                            <div class="desc">
                                                <a href="{{url('company/all-users')}}#tab_1_2">{{$c_request->user->userdetail->first_name}} {{$c_request->user->userdetail->last_name}} requested to be added to.</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <li>
                                <div class="col1">
                                    <div class="cont" style="margin: 0px!important;">
                                        ...
                                        <div class="cont-col2">
                                            <div class="desc">
                                                @if($request->creater_id == Auth::user()->id)
                                                <a href="{{url('contact/user/awaiting')}}">{{$request->createmsg}}.</a>
                                                @elseif($request->receiver_id == Auth::user()->id)
                                                <a href="{{url('contact/user/pending')}}">{{$request->receivemsg}}.</a>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                        ...
                        @if($alertActivities != '')
                        @foreach($alertActivities as $activity)
                        <li>
                            <div class="col1">
                                <div class="cont" style="margin: 0px!important;">
                                    <div class="cont-col1">
                                    ...
                                    <div class="cont-col2">
                                        <div class="desc">
                                            <a href="{{url('manage-purchasing-team-members')}}">{{$activity->activity_name}}.</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li>
                            <div class="col1">
                                <div class="cont" style="margin: 0px!important;">
                                    ...
                                    <div class="cont-col2">
                                        <div class="desc">
                                            <a href="{{url('messages')}}">Received New Message from {{$activity['senderName']}}.</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        @if(count($connectionActivities) > 0)
                        @foreach($connectionActivities as $activity)
                        <li>
                            <div class="col1">
                                <div class="cont" style="margin: 0px!important;">
                                    <div class="cont-col1">
                                    ...
                                    <div class="cont-col2">
                                        <div class="desc">
                                            <a href="{{url('contactusers')}}">{{$activity->msg}}.</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="tab-pane" id="tab2">
                  <div class="portlet-body" id="blockui_sample_1_portlet_body">
                    <div id="dashboard-activities" class="scroller" style="height: 182px;" data-always-visible="1" data-rail-visible="0">
                    
                </div>
                <div class="scroller-footer">
                    <div class="btn-arrow-link pull-right">
                        <a href="{{url('user-activity')}}">See All <br />Notifications</a>
    ...
    <div id="notification-main-div" class="col-md-3 user-alerts relative">
          <h4 class="uppercase text-center"><i class="pull-left fa fa-bell-o"></i> Indy John <b>Now</b> </h4>
          ...
          <div class="portlet">
            ...
            <div class="tab-content portlet-body" id="blockui_sample_2_portlet_body">
              <div class="tab-pane active" id="tab3">
                <div class="portlet-body" id="blockui_sample_2_portlet_body">
                <p>Keep in touch with people and companies that matter to you and your business.</p>
                <div class="uppercase john_now text-center"><h4>Indy John <b>Now</b><br />Launching Soon</h4></div>
                 </div>
              </div>
       ...
       <div class="parner_ship"><h4>PARTNER WITH INDY JOHN<br /><a target="_blank" href="{{url('partner-with-us')}}">LEARN MORE</a></h4></div>
