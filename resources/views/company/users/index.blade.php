        ...
        <div class="portlet box yellow-crusta">
            <div class="portlet-title">
                <div class="caption color-black">
                    <i class="fa fa-server color-black"></i>  Manage Company Users </div>
            </div>
            <div class="portlet-body">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                    ...
                    <tr class="odd gradeX">
                        ...
                        <td>
                            <a id="deleteButton" data-id="{{url('company/user/remove')}}/{{$user->id}}" data-toggle="modal" href="#deleteConfirmation" class="btn btn-circle btn-danger btn-sm">
...
<script>
    ...
    $('#company-user-menu').addClass('active');
    /* end menu active */
