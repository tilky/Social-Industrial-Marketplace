    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="dashboard-stat blue">
            ...
            <div class="details">
                ...
                <div class="desc"> Number of Suppliers </div>
            </div>
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="dashboard-stat red">
            ...
            <div class="details">
                ...
                <div class="desc"> Number of Buyers </div>
            </div>
            <a class="more" href="javascript:;"> View more
                <i class="m-icon-swapright m-icon-white"></i>  
            </a>
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="dashboard-stat green">
            ...
            <div class="details">
                ...
                <div class="desc"> Number of Leads </div>
            </div>
            <a class="more" href="javascript:;"> View more
                <i class="m-icon-swapright m-icon-white"></i>  
            </a>
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="dashboard-stat blue">
            ...
            <div class="details">
                ...
                <div class="desc"> Total Subscriptions </div>
            </div>
            <a class="more" href="javascript:;"> View more
                <i class="m-icon-swapright m-icon-white"></i>  
            </a>
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="dashboard-stat green">
            ...
            <div class="details">
                ...
                <div class="desc"> Total Quotes Matched </div>
            </div>
            <a class="more" href="javascript:;"> View more
                <i class="m-icon-swapright m-icon-white"></i>  
            </a>
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="dashboard-stat red">
            ...
            <div class="details">
                ...
                <div class="desc"> Total Products in Marketplace </div>
            </div>
            <a class="more" href="javascript:;"> View more
                <i class="m-icon-swapright m-icon-white"></i>  
            </a>
