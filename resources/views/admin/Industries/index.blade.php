...
<h3 class="page-title"> Manage Industries
</h3>
<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet box red">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <a href="{{ URL::to('industries/create') }}" class="btn btn-circle btn-sm">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                    ...
                    <tr class="odd gradeX">
                        ...
                        <td>
                            ...
                            <a href="{{ route('industries.edit', $industry->id) }}" class="btn btn-circle btn-success btn-sm">
                                <i class="fa fa-edit"></i>  Edit </a>
                            <a id="deleteButton" data-id="{{$industry->id}}" data-toggle="modal" href="#deleteConfirmation" class="btn btn-circle btn-danger btn-sm">

                            {!! Form::open([
                            'method' => 'DELETE',
                            'id' => 'DELETE_FORM_'.$industry->id,
                            'route' => ['industries.destroy', $industry->id]
                            ]) !!}
                            {!! Form::close() !!}
