    ...
    <div class="col-md-12">
        <div class="portlet box red">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-gift"></i>  Add Quality Standard</div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input data-required="1" type="text" name="name" class="form-control" placeholder="Name of quality standard">
                                </div>
                            </div>
                        </div>
