        ...
        <div class="portlet light form-fit bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green bold uppercase">Select Tech Services</span>
                </div>
                <div class="actions">
            ...
            <div class="portlet-body form">
                <form method="post" action="{{url()}}/companies/info/services/save/{{$company->id}}" class="form-horizontal form-row-seperated">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <div class="col-md-9">
                                ...
                                <select multiple="multiple" class="multi-select" id="company_services" name="company_services[]">
                                    @foreach($company->techServices as $techService)
                                        <option selected value="{{$techService->techService->id}}">{{$techService->techService->name}}</option>
                                    @endforeach
