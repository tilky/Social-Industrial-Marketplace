...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span>Add Quality Standards</span>
        </li>
    </ul>
</div>
<div class="row">
        ...
        <div class="portlet light form-fit bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green bold uppercase">Select Quality Standards</span>
                </div>
                <div class="actions">
            ...
            <div class="portlet-body form">
                <form method="post" action="{{url()}}/companies/info/quality-standards/save/{{$company->id}}" class="form-horizontal form-row-seperated">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <div class="col-md-9">
                                ...
                                <select multiple="multiple" class="multi-select" id="quality_standards" name="quality_standards[]">
                                    @foreach($company->qualityStandards as $qualityStandard)
                                        <option selected value="{{$qualityStandard->qualityStandard->id}}">{{$qualityStandard->qualityStandard->name}}</option>
                                    @endforeach
                                    @foreach($qualityStandards as $qualityStandard)
                                        <option value="{{$qualityStandard->id}}">{{$qualityStandard->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
