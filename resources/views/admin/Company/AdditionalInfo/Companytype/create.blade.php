    ...
    <div class="col-md-12">
        <div class="portlet light form-fit bordered">
            ...
            <div class="portlet-body form">
                <form method="post" action="{{url()}}/companies/info/company-type/save/{{$company->id}}" class="form-horizontal form-row-seperated">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <div class="col-md-9">
                                ...
                                <select multiple="multiple" class="multi-select" id="company_types" name="company_types[]">
                                    @foreach($company->types as $type)
                                        <option selected value="{{$type->type->id}}">{{$type->type->name}}</option>
                                    @endforeach
