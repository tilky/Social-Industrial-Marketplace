        ...
        <div class="col-md-4">
            <div class="thumbnail">
                <div class="caption">
                    ...
                    <button id="plan_FREE_5_0_team" >CURRENT</button>
                    @elseif(Auth::user()->account_member == 'silver' || Auth::user()->account_member == 'gold')
                    <a id="plan_FREE_5_0_0_team" class="downgrade-class" href="{{url('user/packages')}}" >DOWNGRADE</a>
                    @else
                    <button id="plan_FREE_5_0_0_team" class="upgrade" onclick="updatePlan(id,'seller');">UPGRADE</button>
                    @endif
        ...
        <div class="col-md-4">
            <div class="thumbnail">
                <div class="caption">
                    ...
                    <button id="plan_SILVER_4_14900_13000_team" >CURRENT</button>
                    @elseif(Auth::user()->account_member == 'gold')
                    <a id="plan_SILVER_4_14900_13000_team" class="downgrade-class" href="{{url('user/packages')}}" >DOWNGRADE</a>
                    @else
        ...
        <div class="col-md-4">
            <div class="thumbnail gray_color">
                ...
                <div class="caption">
                    ...
                    <button id="plan_GOLD_3_19900_18000_team" >CURRENT</button>
                    @else
                    <button class="upgrade" id="plan_GOLD_3_19900_18000_team" onclick="updatePlan(id,'seller');">UPGRADE</button>
                    @endif
                </div>
            </div>
        </div>
...
<!-- Supplier Footer Modal --->
<div class="modal fade general-pricing" id="create_supplier_subscription_team" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <ul class="nav nav-tabs">
        <li class="active"> <a data-toggle="tab" href="#tab_supplier" aria-expanded="false">Upgrade Your Supplier Crm </a> <button type="button" class="close" data-dismiss="modal" aria-hidden="true"> </button></li>
    </ul>
    <div style="opacity: 1; transition: opacity 0.1s linear 0s;" class="tab-content">
