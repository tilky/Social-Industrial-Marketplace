    ...
    <div class="buttons-toggle">
        <div class="btn-toolbar" id="switch-crm-menu">
            <div class="btn-group btn-group-solid dashboard_btns">
                <a href="{{url('dashboard/buyer')}}" class="btn yellow-bg color-black btn-circle font-yellow-crusta radious-remove-right"><i class="fa fa-circle-thin color-black" style="font-size: 17px;vertical-align: middle;"></i> Buyer Dashboard</a>
                <a href="{{url('dashboard/supplier')}}" class="btn  dark btn-circle font-yellow-crusta radious-remove-left">Supplier CRM <img src="{{url('images/chckbx_chckd.png')}}" width="18px" /></a>
            </div>
        </div>
    </div>
    <!-- BEGIN PAGE TOP -->
