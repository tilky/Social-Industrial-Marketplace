...
<li class="nav-item pulsate-one-target pulsate-four-target" id="quote-main-menu">
    <a href="javascript:;" class="nav-link nav-toggle">
        <img src="{{URL::asset('images/icons/hand-shake.svg')}}" height="40px" width="40px"/>
    ...
    <ul class="sub-menu">
      <li class="nav-item" id="leads-add-menu">
            ...
            <img src="{{URL::asset('images/icons/hand-shake-black.svg')}}" height="20px" width="20px"/>
                <span class="title">Create a Lead Request</span>
            </a>
        </li>
        ...
        <li class="nav-item" id="catalog-upload-menu">
            <a href="{{url('supplier-lead/upload-catalog')}}" class="nav-link ">
                ...
                <span class="title">Upload a Catalog</span>
            </a>
        </li>
...
<li class="nav-item pulsate-three-target" id="team-supplying">
    <a href="javascript:;" class="nav-link nav-toggle">
        <i class="fa fa-group"></i>
        <span class="title">Team Supplying</span>
        <span id="team-supplying-menu-arrow" class="arrow"></span>
    </a>
    <ul class="sub-menu">
        <li class="nav-item" id="about-supplying-teams">
            <a href="{{url('/about-supplying-teams')}}" class="nav-link ">
                <i class="fa fa-group"></i>
                <span class="title">About Teams</span>
            </a>
        </li>
        <li class="nav-item" id="start-supplying-team">
            <a href="{{url('/start-supplying-team')}}" class="nav-link ">
                <i class="fa fa-sitemap"></i>
                <span class="title">Start a New Team</span>
            </a>
        </li>

        <li class="nav-item" id="manage-my-supplying-teams">
            <a href="{{url('/manage-my-supplying-teams')}}" class="nav-link ">
                <i class="fa fa-briefcase"></i>
                <span class="title">Manage My Teams</span>
            </a>
        </li>
       
        <li class="nav-item" id="assign-lead-requests">
            <a href="{{url('/assign-lead-requests')}}" class="nav-link ">
                <i class="fa fa-check-square-o"></i>
                <span class="title">Assigned Lead Requests</span>
            </a>
        </li>

        <li class="nav-item">
             <li class="nav-item" id="message-supplying-team">
            <a href="{{url('/message-supplying-team')}}" class="nav-link ">
...
@if(count(Auth::user()->getSupplierTeam) > 0)
<li class="nav-item pulsate-three-target" id="team-manager-supplying">
    <a href="javascript:;" class="nav-link nav-toggle">
        <i class="fa fa-user-plus"></i>
        <span class="title">Team Manager</span>
        <span id="team-manager-supplying-menu-arrow" class="arrow"></span>
    </a>
    <ul class="sub-menu">
        <li class="nav-item">
             <li class="nav-item" id="manage-supplying-teams">
            <a href="{{url('/manage-supplying-teams')}}" class="nav-link ">
                <i class="fa fa-group"></i>
        ...
        <li class="nav-item">
             <li class="nav-item" id="manage-supplying-team-members">
            <a href="{{url('/manage-supplying-team-members')}}" class="nav-link ">
                <i class="fa fa-sitemap"></i>
                <span class="title">Manage Team Members</span>
            </a>
        </li>

        <li class="nav-item" id="manager-assign-lead-requests">
            <a href="{{url('/manager-assign-lead-requests')}}" class="nav-link ">
                <i class="fa fa-search"></i>
                <span class="title">Assign Lead Requests</span>
            </a>
        </li>

        <li class="nav-item" id="view-assigned-lead-requests">
            <a href="{{url('/view-assigned-lead-requests')}}" class="nav-link ">
                <i class="fa fa-tasks"></i>
                <span class="title">View Assigned Lead Requests</span>
            </a>
        </li>

        <li class="nav-item">
             <li class="nav-item" id="supplying-team-billing">
            <a href="{{url('/supplying-team-billing')}}" class="nav-link ">
                <i class="fa fa-cog"></i>
        ...
        -->
        <li class="nav-item">
             <li class="nav-item" id="transfer-supplying-team">
            <a href="{{url('/transfer-supplying-team')}}" class="nav-link ">
        ...
        <!--connection spot sub-menu things
                ...
                <li id="contact-list-create-menu" class="nav-item">
                    <a href="{{url('contactusers/create')}}" class="nav-link ">
                        <i class="fa fa-user-plus"></i>
                        <span class="title">Find Inder New Connections</span>
                    </a>
                </li>
